...
`in`              | Descendant query, selects locations from one set which are parented under locations in another
`containing`      |  Ancestor query, selections locations from  one set which are parents of locations in another

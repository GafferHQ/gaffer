...
script["as_metal_surface"] = GafferOSL.OSLShader( "as_metal_surface" )
script["as_metal_surface"].loadShader( "surface/as_metal_surface" )
script["ShaderAssignment"]["shader"].setInput( script["as_metal_surface"]["out"]["BRDF"] )

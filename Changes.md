...
- RenderMan :
  - Added `layerPerLightGroup` parameter to outputs. Enabling this causes the output to consist of a layer for each light group in the scene.
  - Any lights that do not have a light group defined will be added to a `default` light group.
